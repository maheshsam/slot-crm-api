...
export class initialSchema1682951185821 implements MigrationInterface {
    name = 'initialSchema1682951185821'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`user_details\` (\`id\` int NOT NULL AUTO_INCREMENT, \`first_name\` varchar(255) NOT NULL, \`middle_name\` varchar(255) NULL, \`last_name\` varchar(255) NULL, \`gender\` varchar(255) NULL, \`date_of_birth\` datetime NULL, \`address_line_1\` varchar(255) NULL, \`address_line_2\` varchar(255) NULL, \`address_line_3\` varchar(255) NULL, \`city\` varchar(255) NULL, \`state\` varchar(255) NULL, \`country\` varchar(255) NULL, \`createdById\` int NULL, \`updatedById\` int NULL, \`is_deleted\` tinyint NOT NULL DEFAULT 0, \`deleted_by\` int NOT NULL DEFAULT '0', \`created_at\` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP, \`updated_at\` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`location\` (\`id\` int NOT NULL AUTO_INCREMENT, \`location_name\` varchar(255) NOT NULL, \`opening_start_time\` varchar(255) NOT NULL, \`details\` text NULL, \`comments\` text NULL, \`address_line_1\` varchar(255) NULL, \`address_line_2\` varchar(255) NULL, \`address_line_3\` varchar(255) NULL, \`city\` varchar(255) NULL, \`state\` varchar(255) NULL, \`country\` varchar(255) NULL, \`is_active\` tinyint NOT NULL DEFAULT 1, \`ownerId\` int NULL, \`createdById\` int NULL, \`updatedById\` int NULL, \`is_deleted\` tinyint NOT NULL DEFAULT 0, \`deleted_by\` int NOT NULL DEFAULT '0', \`created_at\` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP, \`updated_at\` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, UNIQUE INDEX \`REL_c4bb729e05086154519f372186\` (\`ownerId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`permission\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`is_super\` tinyint NOT NULL DEFAULT 0, \`guard_name\` varchar(255) NOT NULL DEFAULT 'web', \`createdById\` int NULL, \`updatedById\` int NULL, \`is_deleted\` tinyint NOT NULL DEFAULT 0, \`deleted_by\` int NOT NULL DEFAULT '0', \`created_at\` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP, \`updated_at\` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`match_point\` (\`id\` int NOT NULL AUTO_INCREMENT, \`check_in_photo\` text NULL, \`check_in_datetime\` datetime NULL, \`match_point\` int NULL, \`machine_number\` int NULL, \`machine_assign_datetime\` datetime NULL, \`status\` tinyint NOT NULL DEFAULT 0, \`customerId\` int NULL, \`addedById\` int NULL, \`currentUserId\` int NULL, \`locationId\` int NULL, \`createdById\` int NULL, \`updatedById\` int NULL, \`is_deleted\` tinyint NOT NULL DEFAULT 0, \`deleted_by\` int NOT NULL DEFAULT '0', \`created_at\` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP, \`updated_at\` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`promotion\` (\`id\` int NOT NULL AUTO_INCREMENT, \`promotion_type\` enum ('RAFFLE', 'DRAWINGS') NOT NULL DEFAULT 'RAFFLE', \`prize_type\` enum ('CASH', 'OTHER') NOT NULL DEFAULT 'CASH', \`prize_details\` varchar(255) NOT NULL, \`promotion_customer_photo\` text NULL, \`customerId\` int NULL, \`addedById\` int NULL, \`locationId\` int NULL, \`createdById\` int NULL, \`updatedById\` int NULL, \`is_deleted\` tinyint NOT NULL DEFAULT 0, \`deleted_by\` int NOT NULL DEFAULT '0', \`created_at\` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP, \`updated_at\` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`ticket_out\` (\`id\` int NOT NULL AUTO_INCREMENT, \`ticket_out_points\` int NOT NULL, \`machine_number\` int NOT NULL, \`ticket_out_photo\` text NULL, \`customerId\` int NULL, \`addedById\` int NULL, \`locationId\` int NULL, \`createdById\` int NULL, \`updatedById\` int NULL, \`is_deleted\` tinyint NOT NULL DEFAULT 0, \`deleted_by\` int NOT NULL DEFAULT '0', \`created_at\` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP, \`updated_at\` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`settings\` (\`id\` int NOT NULL AUTO_INCREMENT, \`settings_key\` varchar(255) NOT NULL, \`settings_value\` text NOT NULL, \`createdById\` int NULL, \`updatedById\` int NULL, \`is_deleted\` tinyint NOT NULL DEFAULT 0, \`deleted_by\` int NOT NULL DEFAULT '0', \`created_at\` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP, \`updated_at\` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, UNIQUE INDEX \`IDX_512dbd1cb7ca5e45acce807d33\` (\`settings_key\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
